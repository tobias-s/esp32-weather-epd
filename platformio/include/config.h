...
#include "config.gary.h"
//#include "config.leingarten.h"
...
// #define POS_UVI         4
// #define POS_AIR_QULITY  5
// #define POS_PRESSURE    6
// #define POS_VISIBILITY  7
#define POS_INTEMP      6
#define POS_INHUMIDITY  8
...
// i.e. setting to 24 will draw a line at day change (i.e. 0 am)
